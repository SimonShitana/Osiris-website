...
const OSIRIS_CONFIG = {
    ...
    moduleResources: {
        'Engineering Mechanics I': [
            { id: 'mech-guide', title: 'Engineering Mechanics Study Guide', type: 'Guide', file: 'resources/pdfs/engineering-mechanics-guide.pdf', demo: 'https://mozilla.github.io/pdf.js/web/compressed.tracemonkey-pldi-09.pdf' },
            { id: 'mech-papers', title: 'Engineering Mechanics Past Papers', type: 'Past Paper', file: 'resources/pdfs/mechanics-past-papers.pdf', demo: 'https://mozilla.github.io/pdf.js/web/compressed.tracemonkey-pldi-09.pdf' }
        ],
        ...
        'Fluid Mechanics I': [
            { id: 'fluid-formulas', title: 'Fluid Mechanics Formula Sheet', type: 'Guide', file: 'resources/pdfs/fluid-mechanics-formulas.pdf', demo: 'https://mozilla.github.io/pdf.js/web/compressed.tracemonkey-pldi-09.pdf' },
            { id: 'fluid-midterm', title: 'Fluid Mechanics Midterm + Solutions', type: 'Past Paper', file: 'resources/pdfs/fluid-mechanics-midterm.pdf', demo: 'https://mozilla.github.io/pdf.js/web/compressed.tracemonkey-pldi-09.pdf' }
        ],
        'Materials Science': [
    ...
    motivationalQuotes: [
        ...
        { text: 'Engineering humanity forward, one student at a time.', author: 'Osiris Agent' },
